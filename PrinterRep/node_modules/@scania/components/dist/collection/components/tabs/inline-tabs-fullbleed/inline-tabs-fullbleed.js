...
export class InlineTabsFullbleed {
  ...
  render() {
    return (h(Host, null,
      h("div", { class: "sdds-inline-tabs-fullbleed" },
        h("div", { class: "sdds-inline-tabs-fullbleed-wrapper", ref: (el) => (this.navWrapperElement = el) },
          h("slot", null)),
        h("div", { class: "sdds-inline-tabs-fullbleed-navigation" },
          h("button", { class: 'sdds-inline-tabs-fullbleed--forward ' +
          ...
          h("button", { class: 'sdds-inline-tabs-fullbleed--back ' +
              (this.showLeftScroll
                ? 'sdds-inline-tabs-fullbleed--back__show'
