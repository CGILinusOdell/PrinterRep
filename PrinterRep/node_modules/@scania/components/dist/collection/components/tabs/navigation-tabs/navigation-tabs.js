...
export class NavigationTabs {
  ...
  render() {
    return (h(Host, null,
      h("div", { class: "sdds-navigation-tabs" },
        h("div", { class: "sdds-navigation-tabs-wrapper", ref: (el) => (this.navWrapperElement = el) },
          h("slot", null)),
        h("div", { class: "sdds-navigation-tabs-navigation" },
          h("button", { class: 'sdds-navigation-tabs--forward ' +
          ...
          h("button", { class: 'sdds-navigation-tabs--back ' +
              (this.showLeftScroll ? 'sdds-navigation-tabs--back__show' : ''), onClick: () => this._scrollLeft() },
            h("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
