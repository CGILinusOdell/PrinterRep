...
.sdds-accordion-item .sdds-accordion-header-prefix,
.sdds-accordion-item .sdds-accordion-header-suffix {
  cursor: pointer;
  display: flex;
  align-items: center;
...
.sdds-accordion-item .sdds-accordion-header-prefix .sdds-accordion-icon,
.sdds-accordion-item .sdds-accordion-header-suffix .sdds-accordion-icon {
...
.sdds-accordion-item .sdds-accordion-header-prefix .sdds-accordion-title {
  order: 1;
}
.sdds-accordion-item .sdds-accordion-header-prefix .sdds-accordion-icon {
  order: 0;
...
.sdds-accordion-item:hover .sdds-accordion-header-prefix,
.sdds-accordion-item:hover .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg-hover);
}
.sdds-accordion-item:focus {
  outline: none;
}
.sdds-accordion-item:focus .sdds-accordion-header-prefix,
.sdds-accordion-item:focus .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg-focus);
  outline: none;
}
.sdds-accordion-item:active .sdds-accordion-header-prefix,
.sdds-accordion-item:active .sdds-accordion-header-suffix, .sdds-accordion-item.active .sdds-accordion-header-prefix,
.sdds-accordion-item.active .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg-active);
  outline: none;
}
.sdds-accordion-item.disabled,
.sdds-accordion-item.disabled .sdds-accordion-header-suffix,
.sdds-accordion-item.disabled .sdds-accordion-header-prefix,
...
.sdds-accordion-item.disabled .sdds-accordion-header-suffix .sdds-accordion-icon,
.sdds-accordion-item.disabled .sdds-accordion-header-prefix .sdds-accordion-icon,
...
.sdds-accordion-item.disabled:hover .sdds-accordion-header-prefix,
.sdds-accordion-item.disabled:hover .sdds-accordion-header-suffix, .sdds-accordion-item.disabled:focus .sdds-accordion-header-prefix,
.sdds-accordion-item.disabled:focus .sdds-accordion-header-suffix, .sdds-accordion-item.disabled:active .sdds-accordion-header-prefix,
.sdds-accordion-item.disabled:active .sdds-accordion-header-suffix, .sdds-accordion-item.disabled.active .sdds-accordion-header-prefix,
.sdds-accordion-item.disabled.active .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg);
  outline: none;
  pointer-events: none;
}
.sdds-accordion-item.disabled:hover .sdds-accordion-header-prefix::after,
.sdds-accordion-item.disabled:hover .sdds-accordion-header-suffix::after, .sdds-accordion-item.disabled:focus .sdds-accordion-header-prefix::after,
.sdds-accordion-item.disabled:focus .sdds-accordion-header-suffix::after, .sdds-accordion-item.disabled:active .sdds-accordion-header-prefix::after,
.sdds-accordion-item.disabled:active .sdds-accordion-header-suffix::after, .sdds-accordion-item.disabled.active .sdds-accordion-header-prefix::after,
.sdds-accordion-item.disabled.active .sdds-accordion-header-suffix::after {
...
.sdds-accordion-item.expanded .sdds-accordion-header-suffix .sdds-accordion-icon {
  margin-right: 0;
  margin-left: var(--sdds-spacing-element-32);
}
.sdds-accordion-item.expanded .sdds-accordion-header-prefix .sdds-accordion-icon {
  margin-left: 0;
...
:host .sdds-accordion-header-prefix,
:host .sdds-accordion-header-suffix {
  position: relative;
}
:host .sdds-accordion-header-prefix::after,
:host .sdds-accordion-header-suffix::after {
  content: "";
  position: absolute;
  width: 100%;
  height: 0;
...
:host(:focus) .sdds-accordion-item .sdds-accordion-header-prefix,
:host(:focus) .sdds-accordion-item .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg-focus);
  outline: none;
}
:host(:focus) .sdds-accordion-item .sdds-accordion-header-prefix::after,
:host(:focus) .sdds-accordion-item .sdds-accordion-header-suffix::after {
...
:host(:focus) .disabled .sdds-accordion-header-prefix,
:host(:focus) .disabled .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg);
  outline: none;
  pointer-events: none;
}
:host(:focus) .disabled .sdds-accordion-header-prefix::after,
:host(:focus) .disabled .sdds-accordion-header-suffix::after {
  border-color: transparent;
}

:host(:active) .sdds-accordion-header-prefix,
:host(:active) .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg-active);
  outline: none;
}
...
:host(:active) .disabled .sdds-accordion-header-prefix,
:host(:active) .disabled .sdds-accordion-header-suffix {
  background-color: var(--sdds-accordion-bg);
  outline: none;
  pointer-events: none;
}
:host(:active) .disabled .sdds-accordion-header-prefix::after,
:host(:active) .disabled .sdds-accordion-header-suffix::after {
  border-color: transparent;
}
...
.sdds-block__onwhite .sdds-block {
  background-color: var(--sdds-white);
}
.sdds-block__ongrey {
  background-color: var(--sdds-white);
}
.sdds-block__ongrey .sdds-block {
  background-color: var(--sdds-grey-50);
}
.sdds-block__ongrey958 {
  background-color: var(--sdds-grey-900);
}
.sdds-block__ongrey958 .sdds-block {
  background-color: var(--sdds-grey-868);
}
.sdds-block__ongrey900 {
  background-color: var(--sdds-grey-868);
}
.sdds-block__ongrey900 .sdds-block {
  background-color: var(--sdds-grey-846);
}
...
.sdds-breadcrumb .sdds-breadcrumb-item:disabled, .sdds-breadcrumb .sdds-breadcrumb-item.disabled, .sdds-breadcrumb .sdds-breadcrumb-item.sdds-breadcrumb-item-current,
.sdds-breadcrumb .sdds-breadcrumb-item [aria-current=page] {
  color: var(--sdds-breadcrumb-color-disabled);
}
.sdds-breadcrumb .sdds-breadcrumb-item:disabled a, .sdds-breadcrumb .sdds-breadcrumb-item.disabled a, .sdds-breadcrumb .sdds-breadcrumb-item.sdds-breadcrumb-item-current a,
.sdds-breadcrumb .sdds-breadcrumb-item [aria-current=page] a {
  cursor: default;
}
.sdds-breadcrumb .sdds-breadcrumb-item:disabled:hover > a, .sdds-breadcrumb .sdds-breadcrumb-item.disabled:hover > a, .sdds-breadcrumb .sdds-breadcrumb-item.sdds-breadcrumb-item-current:hover > a,
...
html {
  ...
  --sdds-btn-secondary-border-color: rgba(0, 0, 0, 0.38);
  --sdds-btn-secondary-background-hover: transparent;
  --sdds-btn-secondary-color-hover: var(--sdds-black);
  --sdds-btn-secondary-border-color-hover: rgba(0, 0, 0, 0.6);
  --sdds-btn-secondary-background-active: transparent;
  --sdds-btn-secondary-color-active: var(--sdds-black);
  --sdds-btn-secondary-border-color-active: rgba(0, 0, 0, 0.87);
  ...
  --sdds-btn-secondary-color-disabled: rgba(0, 0, 0, 0.38);
  --sdds-btn-secondary-border-color-disabled: rgba(0, 0, 0, 0.38);
  ...
  --sdds-btn-ghost-border-color-hover: rgba(0, 0, 0, 0.6);
  --sdds-btn-ghost-background-active: transparent;
  --sdds-btn-ghost-color-active: var(--sdds-black);
  --sdds-btn-ghost-border-color-active: rgba(0, 0, 0, 0.87);
  ...
  --sdds-btn-ghost-color-disabled: rgba(0, 0, 0, 0.38);
  ...
  --sdds-btn-danger-color-disabled: rgba(0, 0, 0, 0.38);
...
.sdds-btn:disabled, .sdds-btn.disabled {
  cursor: unset;
}
.sdds-btn:focus {
  outline: none;
}
.sdds-btn .sdds-btn-icon, .sdds-btn.sdds-btn-icon {
...
.sdds-btn.sdds-btn-fullbleed .sdds-btn-icon, .sdds-btn.sdds-btn-fullbleed.sdds-btn-icon {
...
.sdds-btn.sdds-btn-primary:active, .sdds-btn.sdds-btn-primary.active {
...
.sdds-btn.sdds-btn-primary.disabled, .sdds-btn.sdds-btn-primary:disabled {
  cursor: not-allowed;
...
.sdds-btn.sdds-btn-primary.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-primary.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-primary:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-primary:disabled.sdds-btn-icon {
...
.sdds-btn.sdds-btn-secondary:active, .sdds-btn.sdds-btn-secondary.active {
...
.sdds-btn.sdds-btn-secondary.disabled, .sdds-btn.sdds-btn-secondary:disabled {
  cursor: not-allowed;
...
.sdds-btn.sdds-btn-secondary.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-secondary.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-secondary:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-secondary:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
}
.sdds-btn.sdds-btn-secondary.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-secondary.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-secondary:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-secondary:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
...
.sdds-btn.sdds-btn-ghost:active, .sdds-btn.sdds-btn-ghost.active {
...
.sdds-btn.sdds-btn-ghost.disabled, .sdds-btn.sdds-btn-ghost:disabled {
  cursor: not-allowed;
...
.sdds-btn.sdds-btn-ghost.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-ghost.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-ghost:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-ghost:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
}
.sdds-btn.sdds-btn-ghost.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-ghost.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-ghost:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-ghost:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
...
.sdds-btn.sdds-btn-danger:active, .sdds-btn.sdds-btn-danger.active {
...
.sdds-btn.sdds-btn-danger.disabled, .sdds-btn.sdds-btn-danger:disabled {
  cursor: not-allowed;
...
.sdds-btn.sdds-btn-danger.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-danger.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-danger:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-danger:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
}
.sdds-btn.sdds-btn-danger.disabled .sdds-btn-icon, .sdds-btn.sdds-btn-danger.disabled.sdds-btn-icon, .sdds-btn.sdds-btn-danger:disabled .sdds-btn-icon, .sdds-btn.sdds-btn-danger:disabled.sdds-btn-icon {
  color: var(--sdds-grey-300);
...
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input::input-placeholder {
  color: transparent;
}
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input:placeholder {
  color: transparent;
...
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input-md::input-placeholder {
  color: transparent;
}
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input-md:placeholder {
  color: transparent;
...
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input-sm::input-placeholder {
  color: transparent;
}
.sdds-form-datetime.sdds-datetime-container-label-inside .sdds-datetime-input-sm:placeholder {
  color: transparent;
...
.sdds-link, .sdds-link.active, .sdds-link:active {
  color: var(--sdds-link);
...
.sdds-link:disabled, .sdds-link.disabled {
...
.sdds-radio-button-group .sdds-form-input[type=radio]:checked:before, .sdds-radio-button-group .sdds-form-input[type=radio]:checked:after,
...
.sdds-radio-button-group .sdds-form-input[type=radio]:checked:disabled, .sdds-radio-button-group .sdds-form-input[type=radio]:checked.disabled,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked):disabled,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked).disabled {
  cursor: default;
}
.sdds-radio-button-group .sdds-form-input[type=radio]:checked:disabled:after, .sdds-radio-button-group .sdds-form-input[type=radio]:checked.disabled:after,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked):disabled:after,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked).disabled:after {
  border-color: var(--sdds-radio-button-disabled);
}
.sdds-radio-button-group .sdds-form-input[type=radio]:checked:disabled + label, .sdds-radio-button-group .sdds-form-input[type=radio]:checked.disabled + label,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked):disabled + label,
.sdds-radio-button-group .sdds-form-input[type=radio]:not(:checked).disabled + label {
  color: var(--sdds-radio-button-disabled);
  cursor: default;
}
.sdds-radio-button-group .sdds-form-input[type=radio]:checked:disabled:hover:before, .sdds-radio-button-group .sdds-form-input[type=radio]:checked.disabled:hover:before,
...
.sdds-inline-tabs--forward__show {
  opacity: 1;
  pointer-events: all;
}
.sdds-inline-tabs--forward:hover {
  background-color: var(--sdds-grey-300);
}
.sdds-inline-tabs--forward:active {
...
.sdds-inline-tabs--back__show {
  opacity: 1;
  pointer-events: all;
}
.sdds-inline-tabs--back:hover {
  background-color: var(--sdds-grey-300);
}
.sdds-inline-tabs--back:active {
  background-color: var(--sdds-grey-400);
}
...
.sdds-inline-tabs--tab:focus::before {
  content: " ";
  position: absolute;
  left: 0;
  right: 0;
...
.sdds-inline-tabs--tab__active:focus::before {
  right: -1px;
  left: -1px;
  width: auto;
...
.sdds-inline-tabs--tab:disabled, .sdds-inline-tabs--tab__disabled {
  cursor: initial;
  color: rgba(0, 21, 51, 0.38);
  pointer-events: none;
}

.sdds-inline-tabs-onwhite .sdds-inline-tabs--tab__active {
  background-color: var(--sdds-grey-50);
}
.sdds-inline-tabs-onwhite .sdds-inline-tabs-main {
  background-color: var(--sdds-grey-50);
}

.sdds-inline-tabs-ongrey50 .sdds-inline-tabs--tab__active {
  background-color: var(--sdds-white);
}
.sdds-inline-tabs-ongrey50 .sdds-inline-tabs-main {
  background-color: var(--sdds-white);
}
...
.sdds-inline-tabs-fullbleed--tab:first-child {
  margin-left: 32px;
}
.sdds-inline-tabs-fullbleed--tab:last-child {
  margin-right: 32px;
}
.sdds-inline-tabs-fullbleed--tab::after {
  content: " ";
  position: absolute;
  bottom: 0;
  right: 0;
...
.sdds-inline-tabs-fullbleed--tab:hover {
  color: var(--sdds-blue-958);
}
.sdds-inline-tabs-fullbleed--tab:hover::after {
  width: 100%;
}
.sdds-inline-tabs-fullbleed--tab:focus {
  outline: none;
  color: var(--sdds-grey-958);
}
.sdds-inline-tabs-fullbleed--tab:focus::before {
  content: " ";
  border: 1px solid var(--sdds-blue-400);
  position: absolute;
  top: 11px;
...
.sdds-inline-tabs-fullbleed--tab:focus::after {
  width: 0;
}
.sdds-inline-tabs-fullbleed--tab__active {
  color: var(--sdds-blue-958);
}
.sdds-inline-tabs-fullbleed--tab__active::after {
  width: 100%;
  background-color: var(--sdds-blue-400);
}
.sdds-inline-tabs-fullbleed--tab__active:focus::after {
  width: 100%;
}
.sdds-inline-tabs-fullbleed--tab__disabled {
  color: rgba(0, 21, 51, 0.38);
  pointer-events: none;
}
...
.sdds-inline-tabs-fullbleed__onwhite .sdds-inline-tabs-fullbleed--forward {
  background-color: var(--sdds-white);
}
.sdds-inline-tabs-fullbleed__onwhite .sdds-inline-tabs-fullbleed--back {
  background-color: var(--sdds-white);
}
...
.sdds-inline-tabs-fullbleed__ongrey50 .sdds-inline-tabs-fullbleed--forward {
  background-color: var(--sdds-grey-50);
}
.sdds-inline-tabs-fullbleed__ongrey50 .sdds-inline-tabs-fullbleed--back {
  background-color: var(--sdds-grey-50);
}
...
.sdds-navigation-tabs--tab:first-child {
  margin-left: 32px;
}
.sdds-navigation-tabs--tab:last-child {
  margin-right: 32px;
}
.sdds-navigation-tabs--tab::after {
  content: " ";
  position: absolute;
  bottom: 0;
  right: 0;
...
.sdds-navigation-tabs--tab:hover {
  color: var(--sdds-blue-958);
}
.sdds-navigation-tabs--tab:hover::after {
  width: 100%;
}
.sdds-navigation-tabs--tab:focus {
  outline: none;
  color: var(--sdds-grey-958);
}
.sdds-navigation-tabs--tab:focus::before {
  content: " ";
  border: 1px solid var(--sdds-blue-400);
  position: absolute;
  top: 20px;
...
.sdds-navigation-tabs--tab:focus::after {
  width: 0;
}
.sdds-navigation-tabs--tab__active {
  color: var(--sdds-blue-958);
}
.sdds-navigation-tabs--tab__active::after {
  width: 100%;
  background-color: var(--sdds-blue-400);
}
.sdds-navigation-tabs--tab__active:focus::after {
  width: 100%;
}
.sdds-navigation-tabs--tab__disabled {
  color: rgba(0, 21, 51, 0.6);
  pointer-events: none;
}
...
.sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-focus .sdds-textfield-input-sm ~ .sdds-textfield-label-inside, .sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-data .sdds-textfield-input-sm ~ .sdds-textfield-label-inside {
  font-family: "Scania Sans Semi Condensed", "Scania Sans Condensed", Arial, Helvetica, sans-serif;
  font-size: 2.5rem;
  line-height: 2rem;
  letter-spacing: 0;
...
.sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-focus .sdds-textfield-input-md ~ .sdds-textfield-label-inside, .sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-data .sdds-textfield-input-md ~ .sdds-textfield-label-inside {
  font-family: "Scania Sans Semi Condensed", "Scania Sans Condensed", Arial, Helvetica, sans-serif;
  font-size: 2.5rem;
  line-height: 2rem;
  letter-spacing: 0;
...
.sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-focus .sdds-textfield-input ~ .sdds-textfield-label-inside, .sdds-form-textfield.sdds-textfield-container-label-inside.sdds-textfield-data .sdds-textfield-input ~ .sdds-textfield-label-inside {
  font-family: "Scania Sans Semi Condensed", "Scania Sans Condensed", Arial, Helvetica, sans-serif;
  font-size: 2.5rem;
  line-height: 2rem;
  letter-spacing: 0;
...
.sdds-textfield-bar::before, .sdds-textfield-bar::after {
  content: "";
  height: 2px;
  top: 54px;
  width: 0;
...
.sdds-form-textfield-md .sdds-textfield-bar::before, .sdds-form-textfield-md .sdds-textfield-bar::after {
  top: 46px;
}
.sdds-form-textfield-sm .sdds-textfield-bar::before, .sdds-form-textfield-sm .sdds-textfield-bar::after {
  top: 40px;
}
...
.sdds-textfield-focus .sdds-textfield-bar:before, .sdds-textfield-focus .sdds-textfield-bar:after {
  width: 50%;
}
...
.sdds-form-textfield-disabled slot[name=sdds-prefix]::slotted(*),
.sdds-form-textfield-disabled slot[name=sdds-suffix]::slotted(*) {
  color: var(--sdds-textfield-disabled-ps-color);
}
.sdds-form-textfield-disabled slot[name=sdds-label]::slotted(*) {
  color: var(--sdds-textfield-disabled-label);
}
...
.sdds-form-textfield-error .sdds-textfield-bar::before, .sdds-form-textfield-error .sdds-textfield-bar::after {
  background: var(--sdds-textfield-bar-error);
}
...
slot[name=sdds-prefix]::slotted(*) ~ .sdds-textfield-input  {
  padding-left: var(--sdds-spacing-element-12);
}
...
.sdds-toast {
  ...
  box-shadow: 0px 3px 3px rgba(0, 0, 0, 0.15), 0px -1px 1px rgba(0, 0, 0, 0.1);
  width: 88rem;
...
.sdds-toast-dismiss {
  ...
  width: var(--sdds-spacing-element-16);
  height: var(--sdds-spacing-element-16);
  background-image: url("data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M3.40338 2.34308C3.11048 2.05019 2.63561 2.05019 2.34272 2.34308C2.04982 2.63598 2.04982 3.11085 2.34272 3.40374L6.93897 8L2.34283 12.5961C2.04994 12.889 2.04994 13.3639 2.34283 13.6568C2.63572 13.9497 3.1106 13.9497 3.40349 13.6568L7.99963 9.06066L12.5958 13.6568C12.8887 13.9497 13.3635 13.9497 13.6564 13.6568C13.9493 13.3639 13.9493 12.889 13.6564 12.5961L9.06029 8L13.6565 3.40376C13.9494 3.11086 13.9494 2.63599 13.6565 2.3431C13.3636 2.0502 12.8888 2.0502 12.5959 2.3431L7.99963 6.93934L3.40338 2.34308Z' fill='%23F6F6F7'/%3E%3C/svg%3E%0A");
  background-repeat: no-repeat;
  cursor: pointer;
}
.sdds-toast-body {
...
.sdds-toggle .sdds-toggle-switch:after, .sdds-toggle .sdds-toggle-switch:before {
  content: "";
  position: absolute;
  box-sizing: border-box;
...
.sdds-toggle .sdds-toggle-input:checked + .sdds-toggle-switch:after {
  left: calc(var(--sdds-toggle-slider-width) - 20px);
}
...
.sdds-toggle.sdds-toggle-sm .sdds-toggle-switch, .sdds-toggle.sdds-toggle-sm .sdds-toggle-switch:before {
...
.sdds-toggle.sdds-toggle-sm .sdds-toggle-input:checked + .sdds-toggle-switch:after {
  left: calc(var(--sdds-toggle-slider-sm-width) - 12px);
}
...
.sdds-toggle.disabled .sdds-toggle-input + .sdds-toggle-switch:before, .sdds-toggle.disabled .sdds-toggle-input:checked + .sdds-toggle-switch:before, .sdds-toggle.disabled .sdds-toggle-input:checked:focus + .sdds-toggle-switch:before, .sdds-toggle.disabled .sdds-toggle-input:focus + .sdds-toggle-switch:before {
...
.sdds-table .sdds-table__upper-bar {
...
.sdds-table .sdds-table__searchbar {
  display: flex;
  align-self: center;
  position: relative;
  height: 40px;
...
.sdds-table .sdds-table__searchbar::after {
  content: "";
  width: 100%;
  height: 2px;
  position: absolute;
...
.sdds-table .sdds-table__searchbar:focus-within::after {
  transform: scaleX(100%);
}
.sdds-table .sdds-table__searchbar:focus-within, .sdds-table .sdds-table__searchbar.sdds-table__searchbar--active {
  width: 208px;
  background-color: var(--sdds-grey-50);
}
.sdds-table .sdds-table__searchbar:focus-within:hover, .sdds-table .sdds-table__searchbar.sdds-table__searchbar--active:hover {
  background-color: var(--sdds-grey-50);
}
.sdds-table .sdds-table__searchbar .sdds-table__searchbar-input {
  font-family: "Scania Sans Semi Condensed", "Scania Sans Condensed", Arial, Helvetica, sans-serif;
  font-size: 3.5rem;
  line-height: 4rem;
  letter-spacing: -0.01em;
...
.sdds-table .sdds-table__searchbar .sdds-table__searchbar-input :focus {
  background-color: var(--sdds-grey-50);
}
.sdds-table .sdds-table__searchbar:hover {
  background-color: var(--sdds-grey-300);
}
...
.sdds-table .sdds-table__header .sdds-table__header-cell:first-child {
  border-top-left-radius: 4px;
}
.sdds-table .sdds-table__header .sdds-table__header-cell:last-child {
  border-top-right-radius: 4px;
}
.sdds-table .sdds-table__upper-bar + .sdds-table__header .sdds-table__header-cell,
.sdds-table .sdds-table__upper-bar + .sdds-table__header ::slotted(sdds-header-cell) {
  border-radius: 0;
}
.sdds-table .sdds-table__header .sdds-table__header-cell,
.sdds-table .sdds-table__header ::slotted(sdds-header-cell) {
  font-family: "Scania Sans Semi Condensed", Arial, Helvetica, sans-serif;
  font-weight: bold;
  font-size: 3.5rem;
  line-height: 4rem;
...
.sdds-table .sdds-table__header .sdds-table__header-cell:first-child,
.sdds-table .sdds-table__header ::slotted(sdds-header-cell):first-child {
  border-top-left-radius: 4px;
}
.sdds-table .sdds-table__header .sdds-table__header-cell:last-child,
.sdds-table .sdds-table__header ::slotted(sdds-header-cell):last-child {
  border-top-right-radius: 4px;
}
.sdds-table .sdds-table__header .sdds-table__header-cell--checkbox {
  min-width: unset;
  width: 48px;
  padding: 0;
}
.sdds-table .sdds-table__header ::slotted(sdds-header-cell:hover) {
  background-color: var(--sdds-grey-400);
}
...
.sdds-table .sdds-table__row:hover {
  background-color: var(--sdds-grey-100);
}
.sdds-table .sdds-table__row--selected {
  background-color: var(--sdds-grey-300);
}
.sdds-table .sdds-table__row--selected:hover {
  background-color: var(--sdds-grey-400);
}
.sdds-table .sdds-table__row--hidden {
  display: none;
}
.sdds-table .sdds-table__body-cell,
.sdds-table ::slotted(sdds-body-cell) {
  font-family: "Scania Sans Semi Condensed", "Scania Sans Condensed", Arial, Helvetica, sans-serif;
  font-size: 3.5rem;
  line-height: 4rem;
  letter-spacing: -0.01em;
...
.sdds-table .sdds-table__body-cell--hover {
  background-color: var(--sdds-grey-200);
}
.sdds-table .sdds-table__body-cell--checkbox {
  min-width: 48px;
  width: 48px;
  padding: 0;
}
.sdds-table.sdds-table--compact .sdds-table__upper-bar {
  height: 56px;
}
.sdds-table.sdds-table--compact .sdds-table__body-cell,
.sdds-table.sdds-table--compact ::slotted(sdds-body-cell) {
  padding: var(--sdds-spacing-element-8) var(--sdds-spacing-element-16);
}
.sdds-table.sdds-table--compact .sdds-table__body-cell--checkbox {
  min-width: 32px;
  width: 32px;
  padding: 0;
}
.sdds-table.sdds-table--compact .sdds-table__header-cell,
.sdds-table.sdds-table--compact ::slotted(sdds-header-cell) {
  height: 32px;
}
.sdds-table.sdds-table--compact .sdds-form-label--data-table {
  height: 32px;
}
.sdds-table.sdds-table--divider .sdds-table__header-cell,
.sdds-table.sdds-table--divider ::slotted(sdds-header-cell),
.sdds-table.sdds-table--divider .sdds-table__body-cell,
.sdds-table.sdds-table--divider ::slotted(sdds-body-cell) {
  border-right: 1px solid var(--sdds-grey-400);
}
.sdds-table.sdds-table--divider .sdds-table__header-cell:last-child,
.sdds-table.sdds-table--divider ::slotted(sdds-header-cell:last-child),
.sdds-table.sdds-table--divider .sdds-table__body-cell:last-child,
.sdds-table.sdds-table--divider ::slotted(sdds-body-cell:last-child) {
  border-right: none;
}
.sdds-table.sdds-table--no-min-width .sdds-table__header .sdds-table__header-cell,
.sdds-table.sdds-table--no-min-width .sdds-table__header ::slotted(.sdds-table__header-cell) {
  min-width: unset;
}
.sdds-table.sdds-table--no-min-width .sdds-table__body .sdds-table__body-cell,
.sdds-table.sdds-table--no-min-width .sdds-table__body ::slotted(sdds-body-cell) {
  min-width: unset;
}
.sdds-table.sdds-table--on-white-bg .sdds-table__row {
  background-color: var(--sdds-grey-50);
}
.sdds-table.sdds-table--on-white-bg .sdds-table__row:hover {
  background-color: var(--sdds-grey-200);
}
.sdds-table.sdds-table--multiselect .sdds-table__header ::slotted(.sdds-table__header-cell:first-child) {
  border-top-left-radius: 0;
}
.sdds-table ::slotted(sdds-header-cell:first-child) {
  border-top-left-radius: 4px;
}
.sdds-table ::slotted(sdds-header-cell:last-child) {
  border-top-right-radius: 4px;
}
.sdds-table .sdds-table__upper-bar + .sdds-table__header ::slotted(sdds-header-cell) {
  border-radius: 0;
...
.sdds-dropdown select:active, .sdds-dropdown select.active .sdds-dropdown select.selected {
...
:root, html {
  /*
    Contains spacing variables for the layout
  */
  --sdds-spacing-layout-8: 2rem;
  --sdds-spacing-layout-16: 4rem;
  --sdds-spacing-layout-24: 6rem;
  --sdds-spacing-layout-32: 8rem;
  --sdds-spacing-layout-48: 12rem;
  --sdds-spacing-layout-64: 16rem;
  --sdds-spacing-layout-72: 18rem;
  --sdds-spacing-layout-96: 24rem;
  --sdds-spacing-layout-128: 32rem;
  --sdds-spacing-layout-160: 40rem;
  --sdds-spacing-element-2: 0.5rem;
  --sdds-spacing-element-4: 1rem;
  --sdds-spacing-element-8: 2rem;
  --sdds-spacing-element-12: 3rem;
  --sdds-spacing-element-16: 4rem;
  --sdds-spacing-element-20: 5rem;
  --sdds-spacing-element-24: 6rem;
  --sdds-spacing-element-32: 8rem;
  --sdds-spacing-element-40: 10rem;
  --sdds-spacing-element-48: 12rem;
  --sdds-screen-s: 80rem;
  --sdds-screen-md: 164rem;
  --sdds-screen-l: 264rem;
  --sdds-screen-xl: 328rem;
  --sdds-screen-xxl: 396rem;
  --sdds-grid-xs: 0;
  --sdds-grid-sm: 608px;
  --sdds-grid-md: 800px;
  --sdds-grid-lg: 992px;
...
.sdds-nav.sdds-nav__mob-menu--opened .sdds-nav__overlay, .sdds-nav.sdds-nav__app-launcher--opened .sdds-nav__overlay {
  opacity: 0.4;
  visibility: visible;
}
...
.sdds-nav .sdds-nav__center .sdds-nav__avatar-btn {
  ...
  .sdds-nav .sdds-nav__center .sdds-nav__toolbar-menu .sdds-nav__item-core:first-child {
...
.sdds-footer-top .sdds-footer-title {
  ...
  padding: var(--sdds-footer-top-title-padding-mobile);
...
.sdds-footer-top .sdds-footer-title:hover:after, .sdds-footer-top .sdds-footer-title.hover:after {
...
.sdds-footer-top .sdds-footer-main-links li a {
  padding: var(--sdds-footer-top-link-padding-mobile);
...
.sdds-footer-top .sdds-footer-main-links li a:hover:after, .sdds-footer-top .sdds-footer-main-links li a.hover:after {
  background-color: var(--sdds-footer-top-links-bg-hover);
}
@media all and (min-width: 992px) {
  .sdds-footer-top .sdds-footer-main-links li a {
...
.sdds-footer-top .sdds-footer-main-links li a:hover, .sdds-footer-top .sdds-footer-main-links li a.hover {
  text-decoration: underline;
}
...
.sdds-footer-main {
  ...
  padding: var(--sdds-footer-main-padding-sm);
  display: flex;
  width: 100%;
  align-items: stretch;
  flex-direction: column;
...
.sdds-footer-main .sdds-footer-main-links li a:hover, .sdds-footer-main .sdds-footer-main-links li a.hover {
  text-decoration: underline;
}
...
.sdds-footer-main .sdds-footer-social-links li a:hover, .sdds-footer-main .sdds-footer-social-links li a.hover {
  text-decoration: none;
}
.sdds-footer-main .sdds-footer-main-brand {
  border-top: 1px solid var(--sdds-footer-main-divider);
  padding-top: var(--sdds-footer-brand-padding-top-mobile);
  padding-bottom: var(--sdds-footer-brand-padding-bottom-mobile);
  width: 100%;
...
@media all and (min-width: 800px) {
  .sdds-footer-main {
    padding: var(--sdds-footer-main-padding-md);
  }
}
@media all and (min-width: 992px) {
  .sdds-footer-top {
  ...
  .sdds-footer-main {
    padding: var(--sdds-footer-main-padding);
    flex-direction: row;
    flex-wrap: wrap;
  }
  .sdds-footer-main .sdds-footer-main-links {
  ...
  .sdds-footer-main .sdds-footer-main-brand {
    padding-top: var(--sdds-footer-brand-padding-top);
    padding-bottom: var(--sdds-footer-brand-padding-bottom);
...
html.sdds .sdds-sidebar.expanded,
body.sdds .sdds-sidebar.expanded,
.sdds-body .sdds-sidebar.expanded {
  display: block;
  position: fixed;
  height: 100%;
  z-index: 100;
}
html.sdds .sdds-navbar-menu-popover,
body.sdds .sdds-navbar-menu-popover,
.sdds-body .sdds-navbar-menu-popover {
  display: none;
}
html.sdds .sdds-footer,
body.sdds .sdds-footer,
.sdds-body .sdds-footer {
  margin-top: var(--sdds-spacing-around-footer);
  overflow-x: hidden;
  padding-left: 0;
  padding-right: 0;
}
html.sdds .sdds-content,
...
.sdds-body .sdds-content {
  ...
  html.sdds .sdds-content > .sdds-row,
body.sdds .sdds-content > .sdds-row,
.sdds-body .sdds-content > .sdds-row {
    flex-grow: 1;
  }
  html.sdds .sdds-content > .sdds-footer,
body.sdds .sdds-content > .sdds-footer,
.sdds-body .sdds-content > .sdds-footer {
    flex-basis: auto;
  }
}
