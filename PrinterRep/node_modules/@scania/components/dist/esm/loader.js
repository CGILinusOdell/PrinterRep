import { C as CSS, p as plt, w as win, a as promiseResolve, b as bootstrapLazy } from './index-bff35170.js';
...
const patchEsm = () => {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-862c3146.js').then(() => {
