...
const SddsBadges = class {
  ...
  render() {
    return (index.h("div", { class: `sdds-badges sdds-badges-${this.size} sdds-badges-${this.shape}` }, index.h("div", { class: "sdds-badges-text" }, this.text)));
  }
...
exports.sdds_badges = SddsBadges;
