...
const Modal = class {
  ...
  render() {
    return (index.h(index.Host, { class: `sdds-modal-backdrop ${this.show ? 'show' : 'hide'}` }, index.h("div", { class: `sdds-modal ${this.size ? `sdds-modal-${this.size}` : ''} ` }, index.h("div", { class: "sdds-modal-header" }, index.h("slot", { name: "sdds-modal-headline" }), index.h("span", { class: "sdds-modal-btn" })), index.h("slot", { name: "sdds-modal-body" }), index.h("div", { class: "sdds-modal-actions" }, index.h("slot", { name: "sdds-modal-actions" })))));
  }
